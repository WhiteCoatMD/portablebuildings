...
// Card expand/collapse functionality for Site Customization
function toggleCardExpand(card, event) {
    // Don't expand if clicking on input fields, buttons, or labels
    ...
    if (clickedElement.tagName === 'INPUT' ||
        ...
        clickedElement.closest('.color-preview') ||
        clickedElement.closest('.input-group')) {
        return;
    }
