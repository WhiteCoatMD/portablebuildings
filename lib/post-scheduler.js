...
function calculateNextPostTime(userId, scheduleSettings) {
    ...
    // 5-7 days per week - post almost daily (all 7 days)
    if (postFrequency === '5-7week') {
        const allDays = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'];
        return getNextScheduledTime(now, allDays, schedStartTime, schedEndTime);
    }

    // 3-5 times per week - schedule for weekdays only
