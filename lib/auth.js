 ...
 */
async function createUser(email, password, businessName = null, fullName = null, phone = null, address = null, bestContactEmail = null, manufacturer = 'graceland') {
    try {
        ...
        const result = await pool.query(
            `INSERT INTO users (
                ...
                subscription_status, trial_ends_at, manufacturer
            )
             VALUES ($1, $2, $3, $4, $5, $6, $7, 'trial', $8, $9)
             RETURNING id, email, business_name, full_name, phone, address, best_contact_email, created_at, subscription_status, trial_ends_at, manufacturer`,
            [email, passwordHash, businessName, fullName, phone, address, bestContactEmail, trialEndsAt, manufacturer]
        );
